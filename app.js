/* =============================================
   Center System V13 (Full Professional & Translated)
   Features: Auto-Translate, Search Fix, Full Logic
   ============================================= */

// 1. كبسولة الأمان: الكود مش هيشتغل غير لما الصفحة تحمل
document.addEventListener('DOMContentLoaded', () => {
  console.log("System V13 Loaded...");

  // ====== 2. قاموس الترجمة (Dictionary) ======
  const STRINGS = {
    ar: {
